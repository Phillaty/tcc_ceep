  ...
  <body id="pagina">
    ...
    <div class="container-fluid">
      ...
      <div class="col-12 vvv">
          ...
          <div class="mt-3 text-center"><H3>CADASTRO DE CATEGORIAS ESPECIAIS</H3></div>
      	<form method="post" class="mt-4 row p-2 col-7 png2" action="cadastro_cate_esp.controller.php"><!--PRA LINKA NO CONTROLER-->
      ...
      <a class="bnt btn-warning col-md-4 text-center png4 mt-3 p-2" href="../LOGIN/adm.php"><h6><b>Voltar</b></h6></a>
    </form>
