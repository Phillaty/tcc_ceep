      ...
      <div class="col-12 vvv">
        ...
        <div class="row">
            <div class="container">
              ...
              <div class="text-center mt-3"><H3><ins>CADASTRO DE PRODUTO</ins></H3></div>
    ...
    <form method="post" class="mt-4 row p-2 col-8 png2" action="produto.controller.php"><!--PRA LINKA NO CONTROLER-->
      ...
      <div class="form-group col-md-12">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="Preco" id="Preco" placeholder="Reais">
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="Cent" id="Cent" placeholder="Centavos">
        </div>
      ...
      <div class="form-group col-md-12">
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="img" id="img" placeholder="Coloque a url aqui" maxlength="19">
        </div>
      </div>
      ...
      <a href="../LOGIN/adm.php" class="bnt btn-danger col-md-4 text-center png4 mt-3 p-2 mb-5"><h6"><b>Voltar</b></h6></a>
    </form>
