...
?>
  ...
  <div class="text-center font-weight-bold mt-5 mb-5"><h3>CATEGORIAS ESPECIAIS</h3></div>
    <div class="container-fluid"><div class="row">
...
$buscar3 = mysql_query("SELECT * FROM categoria_esp")or die(mysql_error());

    while($ver = mysql_fetch_array($buscar3))
    {
       echo '
