...
<!--A PARTE DO CONTEUDO-->
      ...
      <div class="col-8 vvv">
        <div class="alert alert-warning"><marquee>ATENÇÃO! O SITE ESTÁ EM CONSTRUÇÃO!! TO CM PREGUIÇA DI TERMINA >u< hihi</marquee></div>
        <div class="container centralizar">
          <h5 class="mt-3">ESTE SITE FOI DESENVOLVIDO POR:</h5><strong>Gustavo Villas Boas e Victor Hugo Cichella da Silva.</strong>
          <div class="container mt-5">
            <div class="row">
              <div class="col-6 nos">VICTOR</div>
              <div class="col-6 nos">GUSTAVO</div>
            </div>
          </div>
          <div class="container mt-3">
            <div class="row">
              <div class="col-6">
                <h6>facebook:<a href="https://www.facebook.com/profile.php?id=100007303353188"> https://www.facebook.com/Victor</a></h6>
              </div>
              ...
              <div class="col-6"><h6>facebook:<a href="https://www.facebook.com/gustavo.villasboas.1"> https://www.facebook.com/Gustavo</a></h6>
              <h6>Twitter:<a href="https://twitter.com/GustavoVillasBR"> https://www.twitter.com/Gustavo</a></h6>
              <h6>Youtube:<a href="https://www.youtube.com/channel/UClgQ7G6e3RE6IhHs1G4t0Lg?">https://www.youtube.com/Antefato</a></h6>
              </div>

              <div class="container">
                <div class="dropdown-divider mt-2"></div>
                <div class="mt-1">Crédito: Site desenvolvido com base em <a href="https://startbootstrap.com/">bootstrap.</a></div>
              </div>
              <div class="container">
                <div class="dropdown-divider mt-2"></div>
                <div class="mt-1">Feito com a ajuda dos professores: André Jandrey <a href="http://jandrey.esy.es/">J W D</a>, Menon e Francielle</div>
              </div>
              <div class="container">
                <div class="dropdown-divider mt-2"></div>
                <div class="mt-1">Coordenador: Lucas</div>
              </div>

              <div class="container">
                <div class="dropdown-divider mt-2"></div>
                <div class="mt-5"><kbd>versão 4.17</kbd></div>
              </div>
            </div>
          </div>
